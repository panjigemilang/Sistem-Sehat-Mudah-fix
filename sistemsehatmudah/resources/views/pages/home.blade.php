...
<body>
    ...
    <script>
    @if(isset($alert))
        alert("Data Dimasukan Kedalam Database!!");
    @endif
    </script>
    <section>
        <div class="main-page">
                ...
                {{-- BMI --}}
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-5">
                            ...
                            <div id="bmi">
                                <form id="form-bmi" action="bmi" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <label class="label-form">Berat</label>
                                        <br>
                                        <input type="number" name="berat" class="control-bmi" placeholder="kg">
                                    </div>
                                    <div class="form-group">
                                        <label class="label-form">Tinggi</label>
                                        <input type="number" step="0.01" name="tinggi" class="control-bmi" placeholder="m">
                                    </div>
                                    <!-- SPACE -->
                                    <br>
                                    ...
                                    <button type="submit" class="btn btn-success btn-lg">Hitung</button>
                                    </div>
                                </form>
                            </div>
                        </div>
